...
# **apiV1AssessmentsGet**
```swift
    open class func apiV1AssessmentsGet(completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
DefaultAPI.apiV1AssessmentsGet() { (response, error) in
...
```swift
    open class func apiV1DailyEntriesGet(completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
DefaultAPI.apiV1DailyEntriesGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **apiV1MedicationsGet**
```swift
    open class func apiV1MedicationsGet(completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
DefaultAPI.apiV1MedicationsGet() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
