...
const mobilePaths = [
  ...
  '/api/v1/patients/me/symptoms/{symptomId}',
  '/api/v1/patients/me/triggers',
  '/api/v1/patients/me/triggers/{triggerId}',
  '/api/v1/patients/me/strategies',
  '/api/v1/patients/me/strategies/{strategyId}',
  '/api/v1/catalogues/triggers',
  '/api/v1/catalogues/symptoms',
  '/api/v1/catalogues/strategies',
